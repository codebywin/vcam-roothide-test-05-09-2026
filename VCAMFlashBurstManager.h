...
/// Kích hoạt 1 cú chớp sáng Flash Burst phản quang chân thực (450ms)
...
/// Cường độ sáng tức thời hiện tại (0.0 -> 0.85 -> 0.0 theo đường cong quang học thực tế)
...
/// Tự động phát hiện khi màn hình chớp trắng chụp ảnh (> 78% độ sáng và tăng vọt > 18%)
