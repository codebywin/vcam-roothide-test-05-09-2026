...
vcamios_FILES      = Tweak.x VCAMLicenseManager.m VCAMFlashLivenessManager.m VCAMTransformManager.m VCAMSecurityGuard.m VCAMPhotoManager.m VCAMVideoManager.m VCAMFlashBurstManager.m
