...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<UIImagePickerControllerInfoKey,id> *)info {
    ...
    [self processSelectedImage:selectedImg presenter:_currentPresenter completion:nil];
}
...
- (void)processSelectedImage:(UIImage *)image presenter:(nullable UIViewController *)presenter completion:(nullable void(^)(BOOL success))completion {
